    ...
    public class ms
    {
        ...
        public static void toggle_inclusion_criteria()
        {
            switch (g.v.key_string)
            {
                ...
                case "평균":
                case "편차":
                    g.v.old_종가기준추정거래액이상_천만원 =
                        g.v.종가기준추정거래액이상_천만원;
                    g.v.old_분당거래액이상_천만원 =
                        g.v.분당거래액이상_천만원;
                    g.v.old_호가거래액_백만원 =
                        g.v.호가거래액_백만원; // not active for g.tesing 호가
                    g.v.old_편차이상 =
                        g.v.편차이상;
                    g.v.old_배차이상 =
                ...
                case "총점":
                    ...
                    g.v.분당거래액이상_천만원 =
                        g.v.old_분당거래액이상_천만원;
                    g.v.호가거래액_백만원 =
                        g.v.old_호가거래액_백만원; // not active for g.tesing 호가
                    g.v.편차이상 =
                        g.v.old_편차이상;
                    g.v.배차이상 =
        ...
        // used but nothing in the routine
        public static void toggle_oands_to_oandg()
        {
        }
        ...
        public static int index_of_optimum_time_interval(g.stock_data o)
        {
            ...
            return g.틱_array_size - 1; // this is not possible, but in the case
        }
